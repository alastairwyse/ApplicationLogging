...
namespace ApplicationLogging.Adapters
{
    ...
    public class ApplicationLoggingLog4NetAdapter : IApplicationLogger
    {
        ...
        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(ApplicationLogging.LogLevel,System.String)"]/*'/>
        public void Log(LogLevel level, string text)
        {
            PerformLogging(level, text, null);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(System.Object,ApplicationLogging.LogLevel,System.String)"]/*'/>
        public void Log(object source, LogLevel level, string text)
        {
            PerformLogging(level, text, null);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(System.Int32,ApplicationLogging.LogLevel,System.String)"]/*'/>
        public void Log(int eventIdentifier, LogLevel level, string text)
        {
            PerformLogging(level, text, null);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(System.Object,System.Int32,ApplicationLogging.LogLevel,System.String)"]/*'/>
        public void Log(object source, int eventIdentifier, LogLevel level, string text)
        {
            PerformLogging(level, text, null);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(ApplicationLogging.LogLevel,System.String,System.Exception)"]/*'/>
        public void Log(LogLevel level, string text, Exception sourceException)
        {
            PerformLogging(level, text, sourceException);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(System.Object,ApplicationLogging.LogLevel,System.String,System.Exception)"]/*'/>
        public void Log(object source, LogLevel level, string text, Exception sourceException)
        {
            PerformLogging(level, text, sourceException);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(System.Int32,ApplicationLogging.LogLevel,System.String,System.Exception)"]/*'/>
        public void Log(int eventIdentifier, LogLevel level, string text, Exception sourceException)
        {
            PerformLogging(level, text, sourceException);
        }

        /// <include file='..\ApplicationLogging\InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:ApplicationLogging.IApplicationLogger.Log(System.Object,System.Int32,ApplicationLogging.LogLevel,System.String,System.Exception)"]/*'/>
